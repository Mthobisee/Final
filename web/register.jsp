...
<body>
  ...
  <div class="floating-container mobile-float ">
    ...
    <div id="st-container" class="st-container modalContainer modal-interface-push">
        ...
        <div class="st-pusher" id="page-register">
            <!-- NOTIFICATIONS -->
            <div class="clearfix"></div>
            <div class="st-content gradient-area margin-bottom-lg">
                <div class="st-content-inner">
                    <!-- extra div for emulating position:fixed of the menu -->
                    <div class="user_flow-banner"></div>
                </div>
                <div class="fill"></div>

                <div class="landing-page-option-wrapper text-center arrow ">
                    <div class="container">
                        <div class="header_container padding-top-lg" class="row">
                            <h2 class="white-text no-margin-bottom">Before we ask you some personal info… </h2>
                            <h4 class="white-text text-center">Keep your details safe and register below.</h4>
                        </div>
                    </div>
                    <div class="row no-margin-bottom">
                        <div class="col offset-l3 offset-m2 offset-s2 l6 m8 s8 no-margin-top">
                            <h6 class="white-text text-center margin-top-md">REGISTER</h6>
                        </div>
                    </div>
                </div>
            ...
            <div id="bottom_section" class="row">
                <div class="container">
                    ...
                    <div class="row form-wrap margin-top-lg ">
                        <form mothod="post" id="register-card" class="col l12 m12 s12 card-slide-in-fade margin-top-lg" action="insert.jsp">
                            <div class="row">
    ...
    <!--scrollTo-->
    <script type="text/javascript" src="Resources/library/scrollto/jquery.scrollTo.min.js"></script>
    <!--Format Currency-->
    <script type="text/javascript" src="Resources/jquery/jquery.formatCurrency.js"></script>
